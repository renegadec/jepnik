...
export default function Home() {
  return (
    <main className="bg-[var(--background)] text-[var(--foreground)]">
      ...
      <section id="home" className="relative overflow-hidden bg-[var(--brand-black)] text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-14 px-6 py-24 lg:grid-cols-[1.2fr_0.8fr] lg:px-8 lg:py-32">
          <div className="max-w-3xl">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <Link
                href="#contact"
                className="inline-flex items-center justify-center rounded-full bg-[var(--brand-gold)] px-7 py-4 text-sm font-semibold text-[var(--brand-black)] transition hover:bg-[var(--brand-gold-soft)]"
              >
                Request a Quote
              </Link>
              <Link
                href="#services"
                className="inline-flex items-center justify-center rounded-full border border-white/20 px-7 py-4 text-sm font-semibold text-white transition hover:border-[var(--brand-gold)] hover:text-[var(--brand-gold)]"
              >
                View Services
              </Link>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-6 lg:px-8">
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
            {trustPoints.map((item) => (
              <div
                key={item}
                className="rounded-2xl border border-black/8 bg-[var(--surface-alt)] px-4 py-4 text-sm font-medium text-[var(--foreground)]"
              >
                {item}
              </div>
            ))}
      ...
      <section id="about" className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div>
            <p className="section-label">About Jepnik</p>
          ...
          <div className="space-y-6 text-lg leading-8 text-[var(--muted)]">
            <p>
              ...
              road surfacing products, civil contracting services, road marking
              and maintenance, and safety product supply. We serve clients who
              need dependable support, clear communication, and practical
              delivery aligned with real project requirements.
            </p>
            <p>
              Whether the need is product supply, contract work, or safety
              equipment, Jepnik&apos;s goal is to make it easier for clients to move
              from enquiry to execution with confidence.
            </p>
          </div>
        </div>
      </section>

      <section id="services" className="bg-[var(--surface-alt)] py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="section-label">What we do</p>
            <h2 className="section-title mt-4">Services built around real project needs</h2>
            <p className="mt-6 text-lg leading-8 text-[var(--muted)]">
              Our work is built around practical support for infrastructure,
              road works, maintenance, and operational safety requirements.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            {services.map((service) => (
              <article
                key={service.title}
                className="rounded-[1.75rem] border border-black/8 bg-white p-8 shadow-[0_10px_40px_rgba(2,2,18,0.06)]"
              >
      ...
      <section className="mx-auto grid max-w-7xl gap-12 px-6 py-24 lg:grid-cols-2 lg:px-8">
        <div>
          ...
          <p className="mt-6 text-lg leading-8 text-[var(--muted)]">
            ...
            looking for a team that communicates clearly, responds
            professionally, and understands the practical realities of delivery.
            Jepnik aims to provide support that reflects reliability,
            professionalism, and service focused on real project outcomes.
          </p>
        </div>
      ...
      <section id="products" className="bg-white py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-[1fr_1fr]">
            <div>
              <p className="section-label">Products & solutions</p>
              <h2 className="section-title mt-4">
                Products and services built for serious project work
              </h2>
              <p className="mt-6 text-lg leading-8 text-[var(--muted)]">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {quickLinks.map((item) => (
                <div
                  key={item}
                  className="rounded-[1.5rem] border border-[var(--brand-gold)]/30 bg-[linear-gradient(180deg,rgba(244,199,0,0.08),rgba(255,255,255,1))] p-6"
                >
      ...
      <section id="projects" className="bg-[var(--surface-alt)] py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div>
              <p className="section-label">Projects & proof</p>
              <h2 className="section-title mt-4">Capability backed by practical work</h2>
              <p className="mt-6 text-lg leading-8 text-[var(--muted)]">
                A strong online presence should do more than describe services —
                it should help clients see evidence of capability. Jepnik&apos;s
                project portfolio can showcase completed work, relevant
                experience, and practical examples that help buyers evaluate fit
                with confidence.
              </p>
            </div>
            <div className="grid gap-4 sm:grid-cols-2">
      ...
      <section id="resources" className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
          ...
          <div className="mt-4 grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
            <div>
              ...
              <p className="mt-5 max-w-3xl text-lg leading-8 text-white/76">
                ...
                Jepnik can provide key documents such as company profile
                material, product catalogues, and certifications through a
      ...
      <section id="contact" className="bg-[var(--brand-gold)] py-20 text-[var(--brand-black)]">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-[1fr_0.8fr] lg:px-8 lg:items-center">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.28em] text-black/70">
              Contact Jepnik
            </p>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-black/75">
              Talk to Jepnik about your supply, service, or project requirement
              and get the right next step from a team focused on practical
          ...
          <div className="rounded-[2rem] bg-white p-8 shadow-[0_18px_40px_rgba(2,2,18,0.12)]">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <a
                href="tel:+263776663738"
                className="inline-flex items-center justify-center rounded-full bg-[var(--brand-black)] px-6 py-4 text-sm font-semibold text-white transition hover:bg-[var(--brand-navy)]"
              >
                Call Now
              </a>
              <a
                href="mailto:info@jepnikinv.co.zw"
                className="inline-flex items-center justify-center rounded-full border border-black/15 px-6 py-4 text-sm font-semibold text-[var(--brand-black)] transition hover:bg-black/5"
              >
                Email Us
              </a>
            </div>
